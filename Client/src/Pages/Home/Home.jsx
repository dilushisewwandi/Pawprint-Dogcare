...
<div className="about-container">
 ...
 <div className="adopt-section">
        ...
        <div className="adopt-content">
          ...
          <button onClick={handleAdoptClick} className="adopt-btn">
            View All Pets
          </button>
        </div>
      </div>
    ...
    <div className='service-content'>
      ...
      <section className='service-details'>
        <p className="service-description">
          Discover a range of pet care services tailored to meet your needs. From grooming and boarding to veterinary check-ups,
